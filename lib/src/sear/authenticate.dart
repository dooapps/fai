...
Future<AuthenticateReturnDataType?> authenticateIdentity(
    FlutterGunSeaClient fluttergun, String soul, String password,
    [String encoding = 'base64']) async {
...
Future<AuthenticateReturnDataType> authenticate(
    FlutterGunSeaClient fluttergun, String alias, String password,
    [Map<String, dynamic> _opt = DEFAULT_OPTS]) async {
