...
Future<SignNodeValueReturnType> signNodeValue(
    GunNode node, String key, PairReturnType pair,
    [String? _encoding]) async {
...
Future<GunNode> signNode(GunNode node, PairReturnType pair,
    [String? encoding]) async {
  encoding ??= DEFAULT_OPTS.encode;

  final GunNode signedNode =
...
Future<GunGraphData> signGraph(GunGraphData graph, PairReturnType pair,
    [String? encoding]) async {
  encoding ??= DEFAULT_OPTS.encode;
