...
import '../../types/fai_graph_adapter.dart';
import '../flow/fai_event.dart';
import '../interfaces.dart';
import '../transports/fai_graph_connector.dart';
import 'fai_graph_node.dart';
import 'fai_graph_utils.dart';
...
class GunGraph {
  ...
  /// @returns a promise
  Future<void> putPath(final List<String> fullPath, GunValue data,
      [GunMsgCb? cb, UUIDFuncType? uuidFn]) async {
  ...
  FutureOr<void> _receiveGraphData(GunGraphData data,
